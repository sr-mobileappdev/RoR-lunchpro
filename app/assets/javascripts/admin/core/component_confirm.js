...
function LPConfirm(component) {
  ...
  this.document_events = {
    ...
    "click .btn-disabled" : "showDisabled"
  ...
  this.showConfirm = function(e) {
    ...
    $(".comp__confirm").find(".__header h2").text(h2_title.replace("{{TITLE}}", title))
  ...
  this.showDisabled = function(e) {
    var that = this

    title = ""
    text = $(e.currentTarget).attr("data-disabled")
    ...
    $(".comp__confirm .__popup_content").html("<p class='small'>"+text+"</p><div class='btn-toolbar mt-3 mb-2' role='toolbar' aria-label='Toolbar with button groups'><a class='btn btn-secondary btn-sm targ-close ml-3' href=''>Ok</a></div>")
  ...
  this.bind_handlers = function() {
    ...
    debug("Component handlers bound for LPConfirm (comp__confirm)")
  };
...
var LPConfirm_Initializer = function() {
