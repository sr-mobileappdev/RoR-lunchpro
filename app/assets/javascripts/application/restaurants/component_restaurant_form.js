...
function LPRestaurantForm(component) {
 ...
 //   "click [data-submit]" : "submitForm"
  ...
  this.events = {
    ...
    "click .form-checkbox" : "toggleNotificationSetting",
    "click .lp__remove_child" : "removeChild",
    "click .lp__cancel_button" : "reloadTab"
  },

  this.reloadTab = function(e) {
  ...
  this.toggleNotificationSetting = function(e) {
  ...
  this.bind_handlers = function() {
    ...
    debug("Component handlers bound for LPRestaurantForm (comp__form)");
  },
...
var LPRestaurantForm_Initializer = function() {
  var component_name = "comp__restaurant_form";
  $("."+component_name).each(function (idx) {
    if (!$(this).hasClass("__comp_active")) {
      obj = new LPRestaurantForm(this);
  ...
  $(document).on( "lp-component.added", function( event, object ) {
    ...
    if ($(object) && $(object).hasClass(component_name)) {
      obj = new LPRestaurantForm(object);
