...
function LPOmStripeForm(component) {
...
var LPOmStripeForm_Initializer = function() {
  var component_name = "comp__om_stripe_form";

  $("."+component_name).each(function (idx) {
    if (!$(this).hasClass("__comp_active")) {
      obj = new LPOmStripeForm(this);
