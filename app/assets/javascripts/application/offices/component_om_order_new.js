...
function LPOmOrderNew(component) {
  ...
  this.bind_handlers = function() {
    ...
    debug("Component handlers bound for LPOmOrderNew(comp__om_order_new)")
  };
...
var LPOmOrderNew_Initializer = function() {
  var component_name = "comp__om_order_new"

  $("."+component_name).each(function (idx) {
      obj = new LPOmOrderNew(this)
