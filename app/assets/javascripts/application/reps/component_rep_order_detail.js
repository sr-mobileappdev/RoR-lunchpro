...
function LPRepOrderDetail(component) {
  ...
  this.events = {  
    ...
    "click .remove_line_item": "disableButton",
    "click .confirm_order": "disableButton"
  ...
  this.bind_handlers = function() {
    ...
    debug("Component handlers bound for LPRepOrderDetail (comp__rep_order_detail)");
  },
...
var LPRepOrderDetail_Initializer = function() {
  var component_name = "comp__rep_order_detail";

  $("."+component_name).each(function (idx) {
      obj = new LPRepOrderDetail(this);
  ...
  $(document).on( "lp-component.added", function( event, object ) {
    ...
    if ($(object) && $(object).hasClass(component_name)) {
      obj = new LPRepOrderDetail(object);
