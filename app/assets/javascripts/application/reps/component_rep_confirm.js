...
function LPRepConfirm(component) {
  ...
  this.bind_handlers = function() {
    ...
    debug("Component handlers bound for LPRepConfirm (comp__confirm)")
  };
...
var LPRepConfirm_Initializer = function() {
  var component_name = "comp__confirm"

  // Initialize a popup holder that will be used for any necessary popups
  $(".__base").prepend("<div class='comp__confirm'><div class='__popup'><div class='__header'><h2></h2><a class='targ-close'><span class='oi oi-x'></span></a></div><div class='__popup_content'></div></div></div>")

  $("."+component_name).each(function (idx) {
    if (!$(this).hasClass("__comp_active")) {
      obj = new LPRepConfirm(this)
